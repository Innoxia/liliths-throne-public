					 ...
					 if(EnchantmentDialogue.getEffects().isEmpty()) {
							...
							Main.game.setContent(new ResponseEffectsOnly("Craft", "Craft '"+EnchantmentDialogue.getOutputName()+"'."){
								...
								public void effects() {
									...
									EnchantmentDialogue.craftItem(EnchantmentDialogue.getIngredient(), EnchantmentDialogue.getEffects(), null);
					...
					if (((EventTarget) MainController.document.getElementById(id)) != null) {
						((EventTarget) MainController.document.getElementById(id)).addEventListener("click", e -> {
							Main.game.setContent(new Response("", "", EnchantmentDialogue.ENCHANTMENT_MENU){
								@Override
								public DialogueNodeOld getNextDialogue() {
									return EnchantmentDialogue.getEnchantmentMenu(BodyChanging.getTarget().getTattooInSlot(invSlot), BodyChanging.getTarget(), invSlot, null);
								}
							});
						}, false);
					}
