...
public class OptionsController {
	...
	public static void initBodiesListeners() {
		...
		PREGNANCY_BREAST_GROWTH.addListeners();
		PREGNANCY_BREAST_GROWTH_LIMIT.addListeners();

		PREGNANCY_LACTATION.addListeners();
		PREGNANCY_LACTATION_LIMIT.addListeners();

		BREAST_SIZE_PREFERENCE.addListeners();
