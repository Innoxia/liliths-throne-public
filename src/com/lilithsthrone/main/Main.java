...
public class Main extends Application {
	...
	public static String patchNotes =
		...
		+ "<p>"
			+ "While there is a world map in this (which you see after completing Lyssieth's section of the main quest), you can't travel to the fields just yet, as I simply ran out of time in which to add content for it."
