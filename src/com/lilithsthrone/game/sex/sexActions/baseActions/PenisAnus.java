...
public class PenisAnus {
	...
	static List<GameCharacter> getOngoingCharacters(GameCharacter characterReceivingDP) {
		return new ArrayList<>(Sex.getOngoingCharactersUsingAreas(characterReceivingDP, SexAreaOrifice.ANUS, SexAreaPenetration.PENIS));
	}
	...
	public static GameCharacter getPrimaryDPPerformer(GameCharacter characterReceivingDP) {
		return Sex.getOngoingActionsMap(characterReceivingDP).get(SexAreaOrifice.ANUS).keySet().iterator().next();
	}
				...
				switch(Sex.getSexPace(Sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Sex.getCharacterPerformingAction(), Sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Sex.getCharacterTargetedForSexAction(this))),
								...
								"With a soft [npc.moan], [npc.name] gently [npc.verb(guide)] the [npc.cockTip+] of [npc.her] [npc.cock] over the exposed parts [npc2.namePos] [npc2.assCloaca+],"
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Sex.getCharacterPerformingAction(), Sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Sex.getCharacterTargetedForSexAction(this))),
								...
								"With [npc.a_moan+], [npc.name] forcefully [npc.verb(rub)] the [npc.cockTip+] of [npc.her] [npc.cock] over the exposed parts [npc2.namePos] [npc2.assCloaca+],"
										+ " indicating that [npc.she] might join [npc3.name] and start double-penetrating [npc2.her] [npc2.asshole+].",
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Sex.getCharacterPerformingAction(), Sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Sex.getCharacterTargetedForSexAction(this))),
								...
								"With [npc.a_moan+], [npc.name] [npc.verb(rub)] the [npc.cockTip+] of [npc.her] [npc.cock] over the exposed parts [npc2.namePos] [npc2.assCloaca+],"
										+ " indicating that [npc.she] might join [npc3.name] and start double-penetrating [npc2.her] [npc2.asshole+].",
					...
					default:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Sex.getCharacterPerformingAction(), Sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Sex.getCharacterTargetedForSexAction(this))),
								...
								"With [npc.a_moan+], [npc.name] enthusiastically [npc.verb(rub)] the [npc.cockTip+] of [npc.her] [npc.cock] over the exposed parts [npc2.namePos] [npc2.assCloaca+],"
										+ " indicating that [npc.she] might join [npc3.name] and start double-penetrating [npc2.her] [npc2.asshole+].",
				...
				switch(Sex.getSexPace(Sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Sex.getCharacterPerformingAction(), Sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Sex.getCharacterTargetedForSexAction(this))),
								...
								"Wanting more than just [npc3.namePos] [npc3.cock+] stuffed in [npc.her] [npc.asshole+],"
										+ " [npc.name] gently [npc.verb(take)] hold of [npc2.namePos] [npc2.cock+], before starting to slide the [npc2.cockTip] up and down between an exposed part of [npc.her] [npc.assCloaca+].",
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Sex.getCharacterPerformingAction(), Sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Sex.getCharacterTargetedForSexAction(this))),
								...
								"Wanting more than just [npc3.namePos] [npc3.cock+] stuffed in [npc.her] [npc.asshole+],"
										+ " [npc.name] roughly [npc.verb(seize)] hold of [npc2.namePos] [npc2.cock+], before starting to forcefully rub the [npc2.cockTip] up and down between an exposed part of [npc.her] [npc.assCloaca+].",
								"With [npc3.namePos] [npc3.cock+] still thrusting in and out of [npc.her] [npc.asshole+],"
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Sex.getCharacterPerformingAction(), Sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Sex.getCharacterTargetedForSexAction(this))),
								...
								"Wanting more than just [npc3.namePos] [npc3.cock+] stuffed in [npc.her] [npc.asshole+],"
										+ " [npc.name] [npc.verb(take)] hold of [npc2.namePos] [npc2.cock+], before starting to rub the [npc2.cockTip] up and down between an exposed part of [npc.her] [npc.assCloaca+].",
								"With [npc3.namePos] [npc3.cock+] still thrusting in and out of [npc.her] [npc.asshole+],"
					...
					default:
						UtilText.nodeContentSB.append(UtilText.parse(Util.newArrayListOfValues(Sex.getCharacterPerformingAction(), Sex.getCharacterTargetedForSexAction(this), getPrimaryDPPerformer(Sex.getCharacterTargetedForSexAction(this))),
								...
								"Wanting more than just [npc3.namePos] [npc3.cock+] stuffed in [npc.her] [npc.asshole+],"
										+ " [npc.name] desperately [npc.verb(seize)] hold of [npc2.namePos] [npc2.cock+], before starting to energetically rub the [npc2.cockTip] up and down between an exposed part of [npc.her] [npc.assCloaca+].",
								"With [npc3.namePos] [npc3.cock+] still thrusting in and out of [npc.her] [npc.asshole+],"
	...
	public static final SexAction ASSHOLE_CONTROL = new SexAction(
		...
		@Override
		public String getDescription() {
			if(PenisAnus.getOngoingCharacters(Sex.getCharacterPerformingAction()).size()>1) {
				return UtilText.parse(PenisAnus.getCharactersForParsing(Sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
	...
	public static final SexAction PENIS_FUCKING_START = new SexAction(
		...
		public String getDescription() {
			...
			switch(Sex.getSexPace(Sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Slowly teasing the [npc.cockTip+] of [npc.her] [npc.cock] between [npc2.namePos] [npc2.assCloaca+],"
							...
							"[npc.Name] [npc.verb(position)] the [npc.cockTip+] of [npc.her] [npc.cock] between [npc2.namePos] [npc2.assCloaca+],"
									+ " and with a slow, steady pressure, [npc.she] gently [npc.verb(sink)] it deep into [npc2.her] [npc2.asshole+]."));
					break;
				case DOM_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Eagerly teasing the [npc.cockTip+] of [npc.her] [npc.cock] between [npc2.namePos] [npc2.assCloaca+],"
				...
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Roughly grinding the [npc.cockTip+] of [npc.her] [npc.cock] between [npc2.namePos] [npc2.assCloaca+],"
				...
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
							"Teasing the [npc.cockTip+] of [npc.her] [npc.cock] between [npc2.namePos] [npc2.assCloaca+],"
	...
	public static final SexAction PENIS_FUCKING_START_ADDITIONAL = new SexAction(
		...
		private List<GameCharacter> getCharactersForParsing() {
			return PenisAnus.getCharactersForParsing(Sex.getCharacterTargetedForSexAction(this));
		}
		...
		public Map<String, Boolean> getAdditionalOngoingAvailableMap() {
			...
			int size = PenisAnus.getOngoingCharacters(Sex.getCharacterTargetedForSexAction(this)).size();
		...
		public String getDescription() {
			...
			switch(Sex.getSexPace(Sex.getCharacterPerformingAction())) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(),
							"Wanting to join in on the fun, [npc.name] [npc.verb(bring)] the [npc.cockHead+] of [npc.her] [npc.cock] up to [npc2.namePos] [npc2.asshole+], and the next time [npc3.namePos] [npc3.verb(pull)] back,"
			...
			switch(Sex.getSexPace(Sex.getCharacterTargetedForSexAction(this))) {
				case DOM_GENTLE:
					UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(),
							" [npc2.Name] [npc2.verb(let)] out a soft [npc2.moan] as the second [npc.cock] enters [npc2.her] [npc2.asshole+], before gently thrusting [npc2.her] [npc2.hips] out in order to sink it deeply in beside [npc3.namePos]."));
					break;
				case DOM_ROUGH:
					UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(),
							" [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as the second [npc.cock] enters [npc2.her] [npc2.asshole+], before roughly slamming [npc2.her] [npc2.hips] out in order to sink it deeply in beside [npc3.namePos]."));
					break;
				case SUB_NORMAL:
					UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(),
							" [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as the second [npc.cock] enters [npc2.her] [npc2.asshole+], before bucking [npc2.her] [npc2.hips] out in order to sink it deeply in beside [npc3.namePos]."));
					break;
				case SUB_RESISTING:
				...
				default:
					UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(),
							" [npc2.Name] [npc2.verb(let)] out [npc2.a_moan+] as the second [npc.cock] enters [npc2.her] [npc2.asshole+], before greedily bucking [npc2.her] [npc2.hips] out in order to sink it deeply in beside [npc3.namePos]."));
					break;
			}
	...
	private static String getTargetedCharacterResponse(SexAction action) {
		if(PenisAnus.getOngoingCharacters(Sex.getCharacterTargetedForSexAction(action)).size()>1) {
			switch(Sex.getSexPace(Sex.getCharacterTargetedForSexAction(action))) {
				case SUB_RESISTING:
					return (UtilText.parse(PenisAnus.getCharactersForParsing(Sex.getCharacterTargetedForSexAction(action)), UtilText.returnStringAtRandom(
							...
							" [npc2.A_sob+] bursts out from between [npc2.namePos] [npc2.lips] as [npc2.she] weakly [npc2.verb(try)] to push [npc.name] and [npc3.name] away,"
									...
									+(getOngoingCharacters(Sex.getCharacterTargetedForSexAction(action)).contains(Main.game.getPlayer())?"you":"them")+" to pull out of [npc2.her] [npc2.asshole+].",
	...
	public static final SexAction PENIS_FUCKING_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisAnus.getOngoingCharacters(Sex.getCharacterTargetedForSexAction(this)).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisAnus.getCharactersForParsing(Sex.getCharacterTargetedForSexAction(this)), UtilText.returnStringAtRandom(
		...
		public String getDescription() {
			...
			if(!Sex.getCharacterPerformingAction().isTaur()) {
				...
				switch(Sex.getSexPace(Sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"[npc.Name] slowly [npc.verb(move)] [npc.her] [npc.hips] until [npc2.namePos] [npc2.cock+] is pressed up to [npc.her] [npc.assCloaca+],"
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"[npc.Name] forcefully [npc.verb(push)] [npc.her] [npc.hips] back until [npc2.namePos] [npc2.cock+] is pressed up to [npc.her] [npc.assCloaca+],"
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"[npc.Name] [npc.verb(push)] [npc.her] [npc.hips] back until [npc2.namePos] [npc2.cock+] is pressed up to [npc.her] [npc.assCloaca+],"
					...
					default:
						UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
								"[npc.Name] eagerly [npc.verb(push)] [npc.her] [npc.hips] back until [npc2.namePos] [npc2.cock+] is pressed up to [npc.her] [npc.assCloaca+],"
	...
	public static final SexAction USING_PENIS_START_ADDITIONAL = new SexAction(
		...
		private List<GameCharacter> getCharactersForParsing() {
			return PenisAnus.getCharactersForParsing(Sex.getCharacterPerformingAction());
		}
		...
		public Map<String, Boolean> getAdditionalOngoingAvailableMap() {
			...
			int size = PenisAnus.getOngoingCharacters(Sex.getCharacterPerformingAction()).size();
				...
				switch(Sex.getSexPace(Sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
							...
							"Wanting more than just [npc3.namePos] [npc3.cock] in [npc.her] [npc.asshole], [npc.name] [npc.verb(take)] hold of [npc2.namePos] [npc2.cock], before gently lining it up to [npc.her] [npc.assCloaca+]."
					...
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
							...
							"Wanting more than just [npc3.namePos] [npc3.cock] in [npc.her] [npc.asshole], [npc.name] forcefully [npc.verb(grab)] [npc2.namePos] [npc2.cock], before quickly lining it up to [npc.her] [npc.assCloaca+]."
					...
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
							...
							"Wanting more than just [npc3.namePos] [npc3.cock] in [npc.her] [npc.asshole], [npc.name] [npc.verb(grab)] [npc2.namePos] [npc2.cock], before lining it up to [npc.her] [npc.assCloaca+]."
					...
					default:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
							...
							"Wanting more than just [npc3.namePos] [npc3.cock] in [npc.her] [npc.asshole], [npc.name] greedily [npc.verb(grab)] [npc2.namePos] [npc2.cock], before quickly lining it up to [npc.her] [npc.assCloaca+]."
				...
				switch(Sex.getSexPace(Sex.getCharacterPerformingAction())) {
					case DOM_GENTLE:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
								...
								"Wanting to be fucked by more than just [npc3.name], [npc.name] [npc.verb(push)] back against [npc2.namePos] [npc2.cock], making sure to line the [npc2.cockHead] up over [npc.her] [npc.assCloaca+]"
										+ " before slowly stepping back and forcing [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.asshole+].")));
						break;
					case DOM_ROUGH:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
								...
								"Wanting to be fucked by more than just [npc3.name], [npc.name] roughly [npc.verb(push)] back against [npc2.namePos] [npc2.cock], making sure to line the [npc2.cockHead] up over [npc.her] [npc.assCloaca+]"
										+ " before dominantly stepping back and forcing [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.asshole+].")));
						break;
					case SUB_NORMAL:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
								...
								"Wanting to be fucked by more than just [npc3.name], [npc.name] [npc.verb(push)] back against [npc2.namePos] [npc2.cock], making sure to line the [npc2.cockHead] up over [npc.her] [npc.assCloaca+]"
										+ " before stepping back and forcing [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.asshole+].")));
						break;
					default:
						UtilText.nodeContentSB.append(UtilText.parse(getCharactersForParsing(), UtilText.returnStringAtRandom(
								...
								"Wanting to be fucked by more than just [npc3.name], [npc.name] desperately [npc.verb(push)] back against [npc2.namePos] [npc2.cock], making sure to line the [npc2.cockHead] up over [npc.her] [npc.assCloaca+]"
										+ " before eagerly stepping back and forcing [npc2.herHim] to join [npc3.name] in double-penetrating [npc.her] [npc.asshole+].")));
						break;
				}
			}
	...
	public static final SexAction RIDING_PENIS_DOM_GENTLE = new SexAction(
		...
		public String getDescription() {
			...
			if(PenisAnus.getOngoingCharacters(Sex.getCharacterPerformingAction()).size()>1) {
				UtilText.nodeContentSB.append(UtilText.parse(PenisAnus.getCharactersForParsing(Sex.getCharacterPerformingAction()), UtilText.returnStringAtRandom(
