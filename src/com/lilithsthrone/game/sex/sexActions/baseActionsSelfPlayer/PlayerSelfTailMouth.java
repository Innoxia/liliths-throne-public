...
public class PlayerSelfTailMouth {
	...
	public static final SexAction PLAYER_SELF_TAIL_MOUTH_LUBRICATION = new SexAction(
		...
		public boolean isBaseRequirementsMet() {
			return !Sex.getWetPenetrationTypes(Main.game.getPlayer()).get(SexAreaPenetration.TAIL).contains(LubricationType.PLAYER_SALIVA);
		}
		...
		public void applyEffects() {
			Sex.transferLubrication(Main.game.getPlayer(), Main.game.getPlayer(), SexAreaPenetration.TAIL, SexAreaOrifice.MOUTH);
		}
	};
