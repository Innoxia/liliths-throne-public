...
public class ChairSex {
	...
	public static final SexAction SWITCH_SITTING_BOTTOM = new SexAction(
		...
		@Override
		public String getDescription() {
			return "[npc.Name] [npc.verb(decide)] to switch positions, and, getting [npc2.name] to stand up, [npc.she] [npc.verb(sit)] [npc.verb(pull)] [npc2.herHim] down onto [npc.her] lap."
