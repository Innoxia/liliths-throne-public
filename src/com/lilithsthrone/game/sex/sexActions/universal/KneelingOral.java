...
public class KneelingOral {
	...
	public static final SexAction PLAYER_ORGASM_THIGH_SQUEEZE = new SexAction(
		...
		public String getActionDescription() {
			return "Squeeze your thighs around [npc.namePos] head and collapse down onto [npc.her] face as you orgasm.";
		}
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(
					"You feel an overwhelming wave of burning arousal start to build up deep within your groin, and with a desperate squeal, you clamp your thighs down hard around [npc.namePos] head."
			...
			if(Main.game.getPlayer().hasPenis()) {
				...
				switch (Main.game.getPlayer().getPenisOrgasmCumQuantity()) {
					case ZERO_NONE:
						...
						break;
					case ONE_TRICKLE:
						UtilText.nodeContentSB.append(", a small trickle of [pc.cum+] squirts out onto the floor above [npc.namePos] head.");
						break;
					case TWO_SMALL_AMOUNT:
						UtilText.nodeContentSB.append(", a small amount of [pc.cum+] squirts out onto the floor above [npc.namePos] head.");
						break;
					case THREE_AVERAGE:
						UtilText.nodeContentSB.append(", your [pc.cum+] squirts out onto the floor above [npc.namePos] head.");
						break;
					case FOUR_LARGE:
						UtilText.nodeContentSB.append(", your [pc.cum+] shoots out onto the floor above [npc.namePos] head.");
						break;
					case FIVE_HUGE:
						UtilText.nodeContentSB.append(", your [pc.cum+] pours out onto the floor above [npc.namePos] head.");
						break;
					case SIX_EXTREME:
						UtilText.nodeContentSB.append(", your [pc.cum+] pours out onto the floor above [npc.namePos] head.");
						break;
			...
			UtilText.nodeContentSB.append("<br/><br/>"
					+ "After a few moments of grinding down on [npc.namePos] face, your overwhelming orgasm starts to fade, and you stand up on shaky [pc.legs],"
	...
	public static final SexAction PLAYER_ORGASM_COCK_DEEPTHROAT = new SexAction(
		...
		@Override
		public String getActionDescription() {
			return "Push your cock deep down [npc.namePos] throat and fill [npc.herHim] with [pc.cum+].";
		}
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append("You feel a desperate heat building in your groin, and with a lewd cry, you slam your [pc.cock+] deep down [npc.namePos] throat.");
			...
			switch (Main.game.getPlayer().getPenisOrgasmCumQuantity()) {
				case ZERO_NONE:
					...
					break;
				case ONE_TRICKLE:
					UtilText.nodeContentSB.append(", you feel a small trickle of [pc.cum+] squirting down [npc.namePos] throat into [npc.her] stomach.");
					break;
				case TWO_SMALL_AMOUNT:
					UtilText.nodeContentSB.append(", you feel a small amount of [pc.cum+] squirting down [npc.namePos] throat into [npc.her] stomach.");
					break;
				case THREE_AVERAGE:
					UtilText.nodeContentSB.append(", you feel your [pc.cum+] squirting down [npc.namePos] throat into [npc.her] stomach.");
					break;
				case FOUR_LARGE:
					UtilText.nodeContentSB.append(", you feel your [pc.cum+] shooting down [npc.namePos] throat into [npc.her] stomach.");
					break;
				case FIVE_HUGE:
					UtilText.nodeContentSB.append(", you feel your [pc.cum+] pouring down [npc.namePos] throat into [npc.her] stomach.");
					break;
				case SIX_EXTREME:
					UtilText.nodeContentSB.append(", you feel your [pc.cum+] pouring down [npc.namePos] throat into [npc.her] stomach.");
					break;
	...
	public static final SexAction PLAYER_ORGASM_COCK_FACIAL = new SexAction(
		...
		@Override
		public String getActionDescription() {
			return "Pull your cock out from [npc.namePos] throat and give [npc.herHim] a facial.";
		}
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append("You feel a desperate heat building in your groin, and with [pc.a_moan+], you pull your [pc.cock] out from [npc.namePos] throat"
					+ (Main.game.getPlayer().isWearingCondom()?", sliding your condom off as you do so.":"."));
			
			if(Main.game.getPlayer().hasPenisModifier(PenetrationModifier.KNOTTED)) {
				UtilText.nodeContentSB.append(" The knot at the base of your [pc.cock+] quickly swells up as you rapidly stroke your shaft over [npc.namePos] [npc.face].");
				
			} else if(Main.game.getPlayer().hasPenisModifier(PenetrationModifier.FLARED)) {
				UtilText.nodeContentSB.append(" The wide, flared head of your [pc.cock+] quickly swells up as you rapidly stroke your shaft over [npc.namePos] [npc.face].");
				
			} else {
				UtilText.nodeContentSB.append(" Your [pc.cock+] starts twitching and throbbing as you rapidly stroke your shaft over [npc.namePos] [npc.face].");
			}
			...
			switch (Main.game.getPlayer().getPenisOrgasmCumQuantity()) {
				case ZERO_NONE:
					...
					break;
				case ONE_TRICKLE:
					UtilText.nodeContentSB.append(", you see a small trickle of [pc.cum+] squirting out all over [npc.namePos] [npc.face+].");
					break;
				case TWO_SMALL_AMOUNT:
					UtilText.nodeContentSB.append(", you see a small amount of [pc.cum+] squirting out all over [npc.namePos] [npc.face+].");
					break;
				case THREE_AVERAGE:
					UtilText.nodeContentSB.append(", you see your [pc.cum+] squirting out all over [npc.namePos] [npc.face+].");
					break;
				case FOUR_LARGE:
					UtilText.nodeContentSB.append(", you see your [pc.cum+] shooting out all over [npc.namePos] [npc.face+].");
					break;
				case FIVE_HUGE:
					UtilText.nodeContentSB.append(", you see your [pc.cum+] pouring out all over [npc.namePos] [npc.face+].");
					break;
				case SIX_EXTREME:
					UtilText.nodeContentSB.append(", you see your [pc.cum+] pouring out all over [npc.namePos] [npc.face+].");
					break;
			...
			UtilText.nodeContentSB.append("<br/><br/>"
					+ "After a moment, you start to come down from your climax, and push your [pc.cock+] past [npc.namePos] [npc.lips+] as you force [npc.herHim] to lick the [pc.cockHead] of your [pc.cock] clean.");
	...
	public static final SexAction PARTNER_ORGASM_THIGH_SQUEEZE = new SexAction(
		...
		@Override
		public String getActionDescription() {
			return "Squeeze your thighs around [pc.namePos] head and collapse down onto [pc.her] face as you orgasm.";
		}
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append(
					...
					+ " You're quickly slammed to the floor, and you find yourself looking up at [npc.namePos] [npc.breasts+] as [npc.she] sits on your face,"
	...
	public static final SexAction PARTNER_ORGASM_CUM_DOWN_THROAT = new SexAction(
		...
		@Override
		public String getActionDescription() {
			return "Push your cock deep down [pc.namePos] throat and fill [pc.herHim] with [npc.cum+].";
		}
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append("You feel [npc.namePos] [npc.cock] start to twitch and throb in your mouth, and before you can react, [npc.she] grabs the sides of your head and slams [npc.her] entire length fully down your throat.");
			...
			if(Sex.getActivePartner().hasVagina()) {
				UtilText.nodeContentSB.append("<br/><br/>"
						+ "Letting out a desperate moan, [npc.namePos] climax drops down into [npc.her] [npc.pussy+],"
	...
	public static final SexAction PARTNER_ORGASM_FACIAL = new SexAction(
		...
		public String getDescription() {
			...
			UtilText.nodeContentSB.append("You feel [npc.namePos] [npc.cock] start to twitch and throb in your mouth, and before you can react, [npc.she] suddenly slides [npc.her] shaft up out of your throat"
			...
			if(Sex.getActivePartner().getVaginaType()!=VaginaType.NONE) {
				UtilText.nodeContentSB.append("<br/><br/>"
						+ "Letting out [npc.a_moan+], [npc.namePos] climax drops down into [npc.her] [npc.pussy+], and [npc.she] roughly grinds [npc.her] feminine sex down against your forehead,"
