...
public class SubCowgirl {
	...
	public static String getPartnerTongueMouthDescription() {
		...
		if (Sex.getPenetrationTypeInOrifice(Sex.getActivePartner(), OrificeType.ANUS_PARTNER) == PenetrationType.PENIS_PLAYER) {
		...
		} else if (Sex.getPenetrationTypeInOrifice(Sex.getActivePartner(), OrificeType.VAGINA_PARTNER) == PenetrationType.PENIS_PLAYER) {
			UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
