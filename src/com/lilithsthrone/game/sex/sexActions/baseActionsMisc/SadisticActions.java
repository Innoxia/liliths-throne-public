...
public class SadisticActions {
	...
	public static final SexAction SLAP_ASS = new SexAction(
		...
		public boolean isBaseRequirementsMet() {
			return (Sex.getSexPositionSlot(Sex.getCharacterTargetedForSexAction(this)).hasTag(SexSlotTag.LOCKED_IN_STOCKS)
					...
					|| (Sex.getSexPositionSlot(Sex.getCharacterTargetedForSexAction(this)).hasTag(SexSlotTag.OVER_DESK_FRONT)
							&& Sex.getSexPositionSlot(Sex.getCharacterPerformingAction()).hasTag(SexSlotTag.OVER_DESK_BETWEEN_LEGS));
		}
