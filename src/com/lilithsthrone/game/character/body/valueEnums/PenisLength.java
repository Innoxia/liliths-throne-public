...
public enum PenisLength {
	...
	/** Average size for a horse morph. Straying into the bounds of "world record for a human". (9-10 inches)*/ 
	FOUR_HUGE("huge", 22, 28, PresetColour.GENERIC_SIZE_FIVE),

	/** Large for a horse morph. Beyond what's physically possible for a non-magical human erection. (11-13 inches)*/
