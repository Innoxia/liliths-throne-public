...
public class OrificePenisUrethra extends AbstractOrifice implements OrificeInterface, Serializable {
	private static final long serialVersionUID = 1L;

	public OrificePenisUrethra(int wetness, float capacity, int elasticity, int plasticity, boolean virgin, Collection<OrificeModifier> orificeModifiers) {
