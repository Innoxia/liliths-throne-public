...
public enum VaginaType implements BodyPartTypeInterface {
	...
	NONE(null, FluidType.GIRL_CUM_HUMAN, null, false),
	...
	private VaginaType(BodyCoveringType skinType, FluidType fluidType, Race race, boolean isEggLayer, OrificeModifier... defaultRacialOrificeModifiers) {
