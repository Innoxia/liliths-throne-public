...
public enum BodyCoveringType {
	...
	BEE(	"A layer of",
			...
			"fuzz",
			"fuzz",
			Util.newArrayListOfValues(new ListValue<CoveringModifier>(CoveringModifier.FUZZ)),
			Util.newArrayListOfValues(new ListValue<CoveringModifier>(CoveringModifier.EXOSKELLTON)),
			Util.newArrayListOfValues(new ListValue<CoveringPattern>(CoveringPattern.STRIPED)),
			Util.newArrayListOfValues(new ListValue<CoveringPattern>(CoveringPattern.HIGHLIGHTS)),
			
			Util.newArrayListOfValues(
					new ListValue<Colour>(Colour.COVERING_BLACK),
					new ListValue<Colour>(Colour.COVERING_GREY),
					new ListValue<Colour>(Colour.BASE_YELLOW),
					new ListValue<Colour>(Colour.BASE_YELLOW_LIGHT),
					new ListValue<Colour>(Colour.BASE_BLACK),
					new ListValue<Colour>(Colour.BASE_PITCH_BLACK)),
			Colour.dyeFurColours,
