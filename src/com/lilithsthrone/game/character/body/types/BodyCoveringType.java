...
public enum BodyCoveringType {
	...
	BEE(	"A layer of",
			...
			"fuzz",
			"fuzz",
			Util.newArrayListOfValues(CoveringModifier.FUZZ),
			Util.newArrayListOfValues(CoveringModifier.EXOSKELLTON),
			Util.newArrayListOfValues(CoveringPattern.STRIPED),
			Util.newArrayListOfValues(CoveringPattern.HIGHLIGHTS),
