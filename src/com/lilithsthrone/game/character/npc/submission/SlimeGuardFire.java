...
public class SlimeGuardFire extends NPC {
	...
	public void setStartingBody(boolean setPersona) {
		...
		// Coverings:
		this.setSkinCovering(new Covering(BodyCoveringType.getBodyCoveringTypeFromId("SLIME_MAIN_SKIN"), PresetColour.COVERING_ORANGE), true);
		this.setSkinCovering(new Covering(BodyCoveringType.getBodyCoveringTypeFromId("SLIME_EYE_IRIS"), PresetColour.COVERING_AMBER), false);
		this.setSkinCovering(new Covering(BodyCoveringType.getBodyCoveringTypeFromId("SLIME_EYE_SCLERA"), PresetColour.COVERING_YELLOW), false);
		this.setSkinCovering(new Covering(BodyCoveringType.getBodyCoveringTypeFromId("SLIME_EYE_PUPIL"), PresetColour.COVERING_ORANGE), false);
		this.setSkinCovering(new Covering(BodyCoveringType.getBodyCoveringTypeFromId("SLIME_ANUS"), CoveringPattern.ORIFICE_ANUS, PresetColour.COVERING_RED, false, PresetColour.COVERING_RED, true), false);
		this.setSkinCovering(new Covering(BodyCoveringType.getBodyCoveringTypeFromId("SLIME_MOUTH"), CoveringPattern.ORIFICE_MOUTH, PresetColour.COVERING_RED, false, PresetColour.COVERING_RED, true), false);
		this.setSkinCovering(new Covering(BodyCoveringType.getBodyCoveringTypeFromId("SLIME_TONGUE"), CoveringPattern.NONE, PresetColour.COVERING_RED, true, PresetColour.COVERING_RED, true), false);
		this.setSkinCovering(new Covering(BodyCoveringType.getBodyCoveringTypeFromId("SLIME_NIPPLE"), PresetColour.COVERING_RED), false);
		this.setSkinCovering(new Covering(BodyCoveringType.getBodyCoveringTypeFromId("SLIME_VAGINA"), CoveringPattern.ORIFICE_VAGINA, PresetColour.COVERING_RED, false, PresetColour.COVERING_RED, true), false);
		this.setSkinCovering(new Covering(BodyCoveringType.getBodyCoveringTypeFromId("SLIME_PENIS"), CoveringPattern.NONE, PresetColour.COVERING_RED, false, PresetColour.COVERING_RED, true), false);

		this.setHairCovering(new Covering(BodyCoveringType.getBodyCoveringTypeFromId("SLIME_HAIR"), PresetColour.COVERING_RED), false);
