...
public class ZaranixMaidKatherine extends NPC {
	...
	public static final DialogueNodeOld AFTER_COMBAT_VICTORY = new DialogueNodeOld("Victory", "", true) {
		...
		public String getContent() {
			return "<p>"
						+ "TODO! You are victorious. You can use the maid (who, still resisting, demands you address her as Katherine), or leave her and carry on."
					+ "</p>";
		}
		...
		public Response getResponse(int responseTab, int index) {
			if(index==1) {
				...
				return new ResponseSex("Use Katherine", "Katherine commands and lift your ass towards her.",
						false, false, Main.game.getKatherine(), new SMDomStanding(), AFTER_SEX_VICTORY);
			} else {
				return null;
			}
		}
	...
	public static final DialogueNodeOld AFTER_COMBAT_DEFEAT = new DialogueNodeOld("Defeated", "", true) {
		...
		public String getContent() {
			return "<p>"
						+ "TODO! You are defeated. The maid introduces herself as Katherine."
					+ "</p>";
		}
