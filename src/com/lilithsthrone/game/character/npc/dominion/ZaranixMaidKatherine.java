...
public class ZaranixMaidKatherine extends NPC {
	...
	public ZaranixMaidKatherine(boolean isImported) {
		super(new NameTriplet("Katherine"),
				...
				10, Gender.F_P_V_B_FUTANARI, RacialBody.DEMON, RaceStage.GREATER, new CharacterInventory(10), WorldType.ZARANIX_HOUSE_GROUND_FLOOR, PlaceType.ZARANIX_GF_MAID, true, null);
