...
public abstract class GameCharacter implements Serializable, XMLSaving {
	...
	protected GameCharacter(NameTriplet nameTriplet, String description, int level, Gender startingGender, RacialBody startingRace, RaceStage stage, CharacterInventory inventory, WorldType worldLocation, PlaceType startingPlace) {
		...
		// Pick random colours
		this.primaryColour = ColourListPresets.NOT_BLACK.getPresetColourList().get(Util.random.nextInt(ColourListPresets.NOT_BLACK.getPresetColourList().size()));
		this.secondaryColour = ColourListPresets.ALL.getPresetColourList().get(Util.random.nextInt(ColourListPresets.ALL.getPresetColourList().size()));
		this.underwearColour = ColourListPresets.ALL.getPresetColourList().get(Util.random.nextInt(ColourListPresets.ALL.getPresetColourList().size()));
		this.leatherColour = ColourListPresets.LEATHER.getPresetColourList().get(Util.random.nextInt(ColourListPresets.LEATHER.getPresetColourList().size()));
		this.denimColour = ColourListPresets.DENIM.getPresetColourList().get(Util.random.nextInt(ColourListPresets.DENIM.getPresetColourList().size()));
		this.metalColour = ColourListPresets.ALL_METAL.getPresetColourList().get(Util.random.nextInt(ColourListPresets.ALL_METAL.getPresetColourList().size()));
