...
public class RacialBody {
	...
	public static AbstractRacialBody DEMON = new AbstractRacialBody(
			...
			PenisType.DEMON_COMMON, 25, PenetrationGirth.THREE_THICK, TesticleSize.FOUR_HUGE, 4, CumProduction.SIX_EXTREME,
	...
	public static AbstractRacialBody RAT_MORPH = new AbstractRacialBody(
			...
			TentacleType.NONE,
			VaginaType.RAT_MORPH, Wetness.TWO_MOIST, Capacity.THREE_SLIGHTLY_LOOSE, OrificeDepth.TWO_AVERAGE, ClitorisSize.ZERO_AVERAGE, OrificeElasticity.FOUR_LIMBER, OrificePlasticity.THREE_RESILIENT,
			Util.newArrayListOfValues(WingType.NONE), WingSize.ZERO_TINY, WingSize.ZERO_TINY,
			GenitalArrangement.NORMAL) {
		@Override
		public Map<PersonalityTrait, Float> getPersonalityTraitChances() {
