...
public enum Race {
	...
	GARGOYLE("gargoyle", "gargoyles",
			...
			"<p>"
				...
				+ " Gargoyles, as a race, have no civilization or culture of their own, and instead imitate those surrounding them."
				+ " If a gargoyle breeds, the resultant offspring always resembles its partner."
			+ "</p>",
