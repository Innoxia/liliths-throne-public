...
public enum FurryPreference {
	...
	HUMAN("Disabled", Colour.TRANSFORMATION_HUMAN, "X") {
		@Override
	...
	MINIMUM("Minimum", Colour.TRANSFORMATION_PARTIAL, "--") {
		@Override
		public String getDescriptionFeminine(Subspecies r) {
	...
	REDUCED("Lesser", Colour.TRANSFORMATION_PARTIAL_FULL, "-") {
		@Override
		public String getDescriptionFeminine(Subspecies r) {
	...
	NORMAL("Greater", Colour.TRANSFORMATION_LESSER, "+") {
		@Override
		public String getDescriptionFeminine(Subspecies r) {
			return "Feminine "+r.getNamePlural(null)+" will spawn with all of the furry parts that the 'Minimum' setting enables (ears, eyes, tails, horns, antenna, and wings)."
	...
	MAXIMUM("Maximum", Colour.TRANSFORMATION_GREATER, "++") {
		@Override
		public String getDescriptionFeminine(Subspecies r) {
