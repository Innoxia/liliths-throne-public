...
public enum SlaveJobSetting {
	...
	MILKING_MILK_DISABLE(PresetColour.BASE_YELLOW_LIGHT, "Forbid Milk", "DM", "Do not allow this slave's milk to be collected."),
	...
	BEDROOM_HELP_WASH(PresetColour.BASE_AQUA, "Washing", "BW", "Have this slave assist you in the bathroom when you wash yourself. (This will override the slave's 'Cleanliness' permissions, as they will get washed with you.)"),
