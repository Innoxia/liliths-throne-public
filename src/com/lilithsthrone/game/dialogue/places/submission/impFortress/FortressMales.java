...
public class FortressMales {
	...
	public static final DialogueNodeOld WELL = new DialogueNodeOld("Well", ".", false) {
		...
		public String getContent() {
			...
			UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("places/submission/fortressMales", "WELL"));
	...
	public static final DialogueNodeOld CELLS = new DialogueNodeOld("Cells", ".", false) {
		...
		public String getContent() {
			...
			UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("places/submission/fortressMales", "CELLS"));
	...
	public static final DialogueNodeOld TREASURY = new DialogueNodeOld("Treasury", ".", false) {
		...
		public String getContent() {
			...
			UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("places/submission/fortressMales", "TREASURY"));
