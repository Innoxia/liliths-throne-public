	...
	public static final DialogueNode ENTRANCE = new DialogueNode("Gateway", "", false) {
		...
		public String getContent() {
			...
			if(isGuardsDefeated()) {
				...
				if(Main.game.getPlayer().getSubspeciesOverride()!=null && Main.game.getPlayer().getSubspeciesOverride().equals(Subspecies.DEMON)) {
			...
			} else if(Main.game.getPlayer().getSubspeciesOverride()!=null && Main.game.getPlayer().getSubspeciesOverride().equals(Subspecies.DEMON)) {
