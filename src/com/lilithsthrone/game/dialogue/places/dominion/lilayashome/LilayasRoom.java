			...
			if(index==1) {
				return new ResponseSex("Submit", "Let Rose push you back on to the bed and fuck you.",
					...
					public void effects() {
						...
						Main.game.getNpc(Rose.class).equipClothingFromNowhere(AbstractClothingType.generateClothing("innoxia_bdsm_penis_strapon", Colour.CLOTHING_PURPLE_DARK, false), true, Main.game.getNpc(Rose.class));
					}
				};
