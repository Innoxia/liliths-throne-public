			...
			if(Main.game.getDialogueFlags().hasFlag(DialogueFlagValue.vickyIntroduced)) {
				return "<p>"
					...
					+ "<p>"
						...
						+ " Even though she's only a few [unit.lSizes] away, and you're the only person in the shop, she doesn't utter a single word of greeting, and you find that the shop's already-gloomy atmosphere has quickly become extremely oppressive."
