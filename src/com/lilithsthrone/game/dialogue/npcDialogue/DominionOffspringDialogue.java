							...
							if(!offspring().flagIntroduced) {
								Main.game.getTextStartStringBuilder().append(
										"<p>"
											...
											+ " [pc.speech([npc.Name], was it? I'm so happy to meet you! I'm sure Lilaya told you, but I'm-)]"
										+ "</p>"
										+ "<p>"
			...
			if(offspring().isAttractedTo(Main.game.getPlayer())) {
				if (index == 1) {
					return new ResponseSex("Incestuous sex",
							...
							AFTER_SEX_VICTORY,
							true, false, offspring(), new SMDomStanding(), AFTER_SEX_CONSENSUAL);
			...
			if(offspring().isAttractedTo(Main.game.getPlayer())) {
				if (index == 1) {
					return new ResponseSex("Sex",
							...
							AFTER_SEX_DEFEAT,
							false, false, offspring(), new SMSubStanding(), AFTER_SEX_DEFEAT,
							"<p>"
