							...
							if(!offspring().hasFlag(NPCFlagValue.flagOffspringIntroduced)) {
								if(offspring().isAttractedTo(Main.game.getPlayer())) {
									Main.game.getTextStartStringBuilder().append(
											...
											+ "</p>"
											+ "<p>"
												+ "You continue with this for some time, and, moving your [pc.hands] down over [npc.her] body, you eagerly grope, stroke, and squeeze every [unit.size] of [npc.her] body that's within your reach."
