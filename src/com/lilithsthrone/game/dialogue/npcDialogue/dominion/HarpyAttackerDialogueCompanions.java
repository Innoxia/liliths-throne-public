				...
				if (index == 1) {
					...
					if(!getHarpy().isAttractedTo(Main.game.getPlayer())) {
						...
						return new ResponseSex(UtilText.parse(companion, "Offer threesome"),
								...
								true, true,
								new SMDoggy(
										Util.newHashMapOfValues(new Value<>(getHarpy(), SexSlotBipeds.DOGGY_BEHIND)),
				...
				if (index == 1) {
					...
					return new ResponseSex("Gentle sex",
							...
							new SMStanding(
									...
									Util.newHashMapOfValues(new Value<>(getHarpy(), SexSlotBipeds.STANDING_SUBMISSIVE))) {
								@Override
					...
					if(!companion.isAttractedTo(getHarpy())) {
						...
						return new ResponseSex(UtilText.parse(companion, "Threesome"),
								...
								new SMDoggy(
										...
										Util.newHashMapOfValues(new Value<>(getHarpy(), SexSlotBipeds.DOGGY_ON_ALL_FOURS))),
								null,
								null,
...
//							System.out.println(potion); 
				...
				if (index == 1) {
					...
					return new ResponseSex("Eager Sex",
							...
							false, false,
							new SMStanding(
									Util.newHashMapOfValues(new Value<>(getHarpy(), SexSlotBipeds.STANDING_DOMINANT)),
