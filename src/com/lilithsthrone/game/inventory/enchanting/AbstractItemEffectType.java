		...
		switch(primaryModifier) {
			...
			case TF_HORNS:
				switch(secondaryModifier) {
					...
					default:
						return new RacialEffectUtil(Util.capitaliseSentence(race.getName())+" horns transformation.") {
			...
			case TF_PENIS:
				switch(secondaryModifier) {
					...
					case TF_MOD_WETNESS:
						switch(potency) {
							case MAJOR_DRAIN:
								return new RacialEffectUtil("Huge decrease in maximum cum storage. (" + Units.fluid(largeChangeMajorDrain) + ")") { @Override public String applyEffect() { return target.incrementPenisCumStorage(largeChangeMajorDrain); } };
							case DRAIN:
								return new RacialEffectUtil("Decrease in maximum cum storage. (" + Units.fluid(largeChangeDrain) + ")") { @Override public String applyEffect() { return target.incrementPenisCumStorage(largeChangeDrain); } };
							case MINOR_DRAIN:
								return new RacialEffectUtil("Small decrease in maximum cum storage. (" + Units.fluid(largeChangeMinorDrain) + ")") { @Override public String applyEffect() { return target.incrementPenisCumStorage(largeChangeMinorDrain); } };
							case MINOR_BOOST: default:
								return new RacialEffectUtil("Small increase in maximum cum storage. (+" + Units.fluid(largeChangeMinorBoost) + ")") { @Override public String applyEffect() { return target.incrementPenisCumStorage(largeChangeMinorBoost); } };
							case BOOST:
								return new RacialEffectUtil("Increase in maximum cum storage. (+" + Units.fluid(largeChangeBoost) + ")") { @Override public String applyEffect() { return target.incrementPenisCumStorage(largeChangeBoost); } };
							case MAJOR_BOOST:
								return new RacialEffectUtil("Huge increase in maximum cum storage. (+" + Units.fluid(largeChangeMajorBoost) + ")") { @Override public String applyEffect() { return target.incrementPenisCumStorage(largeChangeMajorBoost); } };
						}
					case TF_MOD_REGENERATION:
						switch(potency) {
							case MAJOR_DRAIN:
			...
			case TF_TAIL:
				switch(secondaryModifier) {
					...
					default:
						return new RacialEffectUtil(Util.capitaliseSentence(race.getName())+" tail transformation.") {
			...
			case TF_WINGS:
				switch(secondaryModifier) {
					...
					default:
						return new RacialEffectUtil(Util.capitaliseSentence(race.getName())+" wings transformation.") {
