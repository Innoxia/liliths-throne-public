			...
			inventorySB.append(
					...
					+"<p style='width:100%; text-align:center; padding:0 margin:0;'>"
						+(charactersInventoryToRender.isPlayer()
							?"<b style='color:"+charactersInventoryToRender.getSpeechColour()+";'>Your</b> <b>Inventory | Page "+(charactersInventoryToRender.isPlayer()?pageLeft+1:pageRight+1)+"</b>"
				...
				for(NPC character : charactersPresent) {
					uiAttributeSB.append(
							"<div class='event-log-entry' style='background:"+getEntryBackgroundColour(count%2==0)+";'>"
								+" <span style='color:"+character.getSpeechColour()+";'>"+(!character.getArtworkList().isEmpty() && Main.getProperties().hasValue(PropertyValue.artwork)?"&#128247; ":"")+character.getName("A")+"</span>"
								+ " - "
