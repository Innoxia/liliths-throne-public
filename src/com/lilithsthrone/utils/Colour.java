...
//	ATTRIBUTE_FITNESS(BaseColour.LILAC, "light purple", Util.newArrayListOfValues("fitness", "fit")),
	...
	BLADDER_STAGE_ZERO(false, Util.newColour(0xfcffe2), Util.newColour(0xfcffe2), "yellow"),
	BLADDER_STAGE_ONE(false, Util.newColour(0xfcffb8), Util.newColour(0xfcffb8), "yellow"),
	BLADDER_STAGE_TWO(false, Util.newColour(0xf9ff93), Util.newColour(0xf9ff93), "yellow"),
	BLADDER_STAGE_THREE(false, Util.newColour(0xfbf671), Util.newColour(0xfbf671), "yellow"),
	BLADDER_STAGE_FOUR(false, Util.newColour(0xe8cb55), Util.newColour(0xe8cb55), "yellow"),
	BLADDER_STAGE_FIVE(false, Util.newColour(0xe07b21), Util.newColour(0xe07b21), "orange"),

	THIRST_STAGE_ZERO(false, Util.newColour(0x274287), Util.newColour(0x274287), "blue"),
	THIRST_STAGE_ONE(false, Util.newColour(0x7ea0f4), Util.newColour(0x7ea0f4), "light blue"),
	THIRST_STAGE_TWO(false, Util.newColour(0xacc0f3), Util.newColour(0xacc0f3), "light blue"),
	THIRST_STAGE_THREE(false, Util.newColour(0xc9bd5b), Util.newColour(0xc9bd5b), "light yellow"),
	THIRST_STAGE_FOUR(false, Util.newColour(0xffe400), Util.newColour(0xffe400), "yellow"),
	THIRST_STAGE_FIVE(false, Util.newColour(0xa76200), Util.newColour(0xa76200), "light orange"),

	HUNGER_STAGE_ZERO(false, Util.newColour(0x27b700), Util.newColour(0x27b700), "green"),
	HUNGER_STAGE_ONE(false, Util.newColour(0x71b060), Util.newColour(0x71b060), "light green"),
	HUNGER_STAGE_TWO(false, Util.newColour(0xc0e5b6), Util.newColour(0xc0e5b6), "light green"),
	HUNGER_STAGE_THREE(false, Util.newColour(0xc9bd5b), Util.newColour(0xc9bd5b), "light yellow"),
	HUNGER_STAGE_FOUR(false, Util.newColour(0xffe400), Util.newColour(0xffe400), "yellow"),
	HUNGER_STAGE_FIVE(false, Util.newColour(0xa76200), Util.newColour(0xa76200), "light orange"),
	...
	BLADDER(false, Util.newColour(0xfbf671), Util.newColour(0xfbf671), "yellow"),
