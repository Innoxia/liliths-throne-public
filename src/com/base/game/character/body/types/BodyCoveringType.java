...
public enum BodyCoveringType implements BodyPartTypeInterface {
	...
	BOVINE_PENIS(Race.COW_MORPH,
			"a layer of",
			false,
			"skin",
			"skin",
			"thick",
			Util.newArrayListOfValues(new ListValue<Colour>(Colour.BOVINE_COCK)),
			null),

	BOVINE_VAGINA(Race.COW_MORPH,
			"a layer of",
			false,
			"skin",
			"skin",
			"thick",
			Util.newArrayListOfValues(new ListValue<Colour>(Colour.BOVINE_VAGINA)),
			null),

	BOVINE_ASSHOLE(Race.COW_MORPH,
			"a layer of",
			false,
			"skin",
			"skin",
			"thick",
			Util.newArrayListOfValues(new ListValue<Colour>(Colour.BOVINE_ASSHOLE)),
			null),
