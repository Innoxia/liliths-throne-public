...
public enum Fetish implements PerkInterface {
	...
	FETISH_CUM_STUD(60,
			...
			Util.newArrayListOfValues(new ListValue<>(
					"<span style='color:"
							...
							+ ";'>Unlocks</span> <span style='color:"
							+ Colour.GENERIC_SEX.toWebHexString()
							+ ";'>cum stud tease</span> (Requires penis)"),
					new ListValue<>(
							"<span style='color:"
									+ Colour.GENERIC_BAD.toWebHexString()
									+ ";'>Weak to</span> <span style='color:"
		...
		public String getDescription(GameCharacter owner) {
			if (owner.isPlayer())
				...
				return UtilText.parse(owner,
						"[npc.Name] has a fetish for cumming.");
		}
	...
	FETISH_DEFLOWERING(60,
			...
			null,
			Util.newArrayListOfValues(new ListValue<>(
					"Gain <span style='color:"
							+ Colour.GENERIC_EXPERIENCE.toWebHexString()
							+ ";'>xp</span> from <span style='color:"
							+ Colour.GENERIC_ARCANE.toWebHexString()
							+ ";'>taking virginities</span>")),
			null) {
		...
		public String getDescription(GameCharacter owner) {
			if (owner.isPlayer()) {
				...
				return UtilText.parse(owner,
						"[npc.Name] has a fetish for deflowering. [npc.She] loves being the one to break a girl's hymen, but also enjoys being the first to fuck a person's ass, nipples, or throat.");
			}
		}
	...
	FETISH_PURE_VIRGIN(60,
			...
			Util.newArrayListOfValues(new ListValue<>(
					"<span style='color:"
							+ Colour.GENERIC_GOOD.toWebHexString()
							+ ";'>Gain</span> <span style='color:"
							+ Colour.GENERIC_EXCELLENT.toWebHexString()
							+ ";'>'pure virgin'</span>"),
					new ListValue<>(
							"<span style='color:"
									+ Colour.GENERIC_BAD.toWebHexString()
									+ ";'>Suffer</span> <span style='color:"
									+ Colour.GENERIC_ARCANE.toWebHexString()
									+ ";'>'broken virgin'</span>")),
			null) {
		@Override
	...
	FETISH_PREGNANCY(60,
			...
			Util.newArrayListOfValues(new ListValue<>(
					"<span style='color:"
							...
							+ ";'>Unlocks</span> <span style='color:"
							+ Colour.GENERIC_SEX.toWebHexString()
							+ ";'>fertility tease</span> (Requires vagina)"),
					new ListValue<>(
							"<span style='color:"
									+ Colour.GENERIC_BAD.toWebHexString()
									+ ";'>Weak to</span> <span style='color:"
		...
		public String getDescription(GameCharacter owner) {
			if (owner.isPlayer()) {
				...
				return UtilText.parse(owner,
						"[npc.Name] has a fetish for being impregnated.");
			}
		}
	...
	FETISH_IMPREGNATION(60,
			...
			Util.newArrayListOfValues(new ListValue<>(
					"<span style='color:"
							...
							+ ";'>Unlocks</span> <span style='color:"
							+ Colour.GENERIC_SEX.toWebHexString()
							+ ";'>virility tease</span> (Requires penis)"),
					new ListValue<>(
							"<span style='color:"
									+ Colour.GENERIC_BAD.toWebHexString()
									+ ";'>Weak to</span> <span style='color:"
									+ Colour.GENERIC_SEX.toWebHexString()
									+ ";'>fertility tease</span>")),
			null) {
		@Override
		public String applyPerkGained(GameCharacter character) {
			return UtilText.parsePlayerThought("");
		...
		public String getDescription(GameCharacter owner) {
			if (owner.isPlayer()) {
				...
				return UtilText.parse(owner,
						"[npc.Name] has a fetish for getting girls pregnant.");
			}
		}
	...
	FETISH_BROODMOTHER(60,
			...
			Util.newHashMapOfValues(new Value<Attribute, Integer>(
					...
					10)),
			Util.newArrayListOfValues(new ListValue<>(
					"2 x <span style='color:"
							+ Colour.GENERIC_SEX.toWebHexString()
							+ ";'>Children in mothered litters</span>")),
			null) {
		@Override
		public String applyPerkGained(GameCharacter character) {
			return UtilText.parsePlayerThought("");
		...
		public String getDescription(GameCharacter owner) {
			if (owner.isPlayer()) {
				...
				return UtilText.parse(owner,
						"[npc.Name]'s body is built for one thing; pumping out as many children as possible."
	...
	FETISH_SEEDER(60,
			...
			Util.newArrayListOfValues(new ListValue<>(
					"2 x <span style='color:"
							+ Colour.GENERIC_SEX.toWebHexString()
							+ ";'>Children in fathered litters</span>")),
			null) {
		@Override
		public String applyPerkGained(GameCharacter character) {
			return UtilText.parsePlayerThought("");
		...
		public String getDescription(GameCharacter owner) {
			if (owner.isPlayer()) {
				...
				return UtilText.parse(owner,
						"[npc.Name]'s seed has the potent effect of causing anyone impregnated by it to give birth to huge numbers of children.");
			}
		}
	...
	FETISH_TRANSFORMATION(60, // TODO
			...
			Util.newArrayListOfValues(new ListValue<>(
					"<span style='color:"
							...
							+ ";'>Unlocks</span> <span style='color:"
							+ Colour.GENERIC_SEX.toWebHexString()
							+ ";'>transformation scenes</span>"),
					new ListValue<>(
							"<span style='color:"
									+ Colour.GENERIC_GOOD.toWebHexString()
									+ ";'>Unlocks</span> <span style='color:"
									+ Colour.GENERIC_ARCANE.toWebHexString()
									+ ";'>forced transformations</span>"),
					new ListValue<>(
							"<span style='color:"
									+ Colour.GENERIC_BAD.toWebHexString()
	...
	FETISH_CROSS_DRESSER(60,
			...
			Util.newArrayListOfValues(new ListValue<>(
					"<span style='color:"
							+ Colour.GENERIC_GOOD.toWebHexString()
							+ ";'>Immune to clothing femininity status effects</span>")),
			null) {
		@Override
		public String applyPerkGained(GameCharacter character) {
			return UtilText.parsePlayerThought("");
		...
		public String getDescription(GameCharacter owner) {
			if (owner.isPlayer()) {
				...
				return UtilText.parse(owner,
						"[npc.Name] loves wearing all manner of different clothing, and [npc.she] doesn't really care if it's too masculine or feminine for [npc.her] body.");
			}
		}
	...
	FETISH_DENIAL(60,
			...
			null,
			Util.newArrayListOfValues(new ListValue<>(
					"Unlocks <span style='color:"
							+ Colour.GENERIC_ARCANE.toWebHexString()
							+ ";'>Deny</span> in non-submissive sex")),
			null) {
		@Override
		public String applyPerkGained(GameCharacter character) {
			return UtilText.parsePlayerThought("");
	...
	FETISH_MASOCHIST(60,
			...
			null,
			Util.newArrayListOfValues(new ListValue<>(
					"40% of incoming <span style='color:"
	...
	FETISH_SADIST(60,
			...
			Util.newHashMapOfValues(new Value<Attribute, Integer>(
					...
					5)),
			Util.newArrayListOfValues(new ListValue<>(
					"You take 10% of dealt <span style='color:"
							+ Colour.ATTRIBUTE_HEALTH.toWebHexString()
							+ ";'>health damage</span> as "
							+ " <span style='color:"
							+ Colour.DAMAGE_TYPE_MANA.toWebHexString()
							+ ";'>willpower damage</span>")),
			null) {
	...
	FETISH_NON_CON(60,
			...
			Util.newArrayListOfValues(new ListValue<>(
					"<span style='color:"
							...
							+ ";'>Unlocks</span> <span style='color:"
							+ Colour.GENERIC_SEX.toWebHexString()
							+ ";'>Resist sex pace</span>"),
					new ListValue<>(
							"<span style='color:"
									+ Colour.GENERIC_GOOD.toWebHexString()
									+ ";'>Unlocks</span> <span style='color:"
									+ Colour.GENERIC_ARCANE.toWebHexString()
									+ ";'>Non-consensual scenes</span>")),
			null) {
		@Override
		public String applyPerkGained(GameCharacter character) {
			return UtilText.parsePlayerThought("");
		...
		public String getDescription(GameCharacter owner) {
			if (owner.isPlayer()) {
				...
				return UtilText.parse(owner,
						"[npc.Name] has a fetish for non-consensual encounters.");
			}
		}
	...
	FETISH_SWITCH(60,
		...
		public String getDescription(GameCharacter owner) {
			if (owner.isPlayer())
				...
				return UtilText.parse(owner,
						"[npc.Name] is happy to play as either the dom or sub during sex.");
		}
	...
	FETISH_BREEDER(60,
		...
		public String getDescription(GameCharacter owner) {
			if (owner.isPlayer())
				...
				return UtilText.parse(owner,
						"[npc.Name] wants nothing more than to share [npc.her] love of pregnancies with everyone [npc.she] meets.");
		}
	...
	FETISH_SADOMASOCHIST(60,
		...
		public String getDescription(GameCharacter owner) {
			if (owner.isPlayer())
				...
				return UtilText.parse(owner,
						"[npc.Name] loves pain and humiliation in all of its forms.");
		}
	...
	private Fetish(int renderingPriority, String name, String pathName, Colour colourShade, HashMap<Attribute, Integer> attributeModifiers, List<String> extraEffects, List<Fetish> fetishesForAutomaticUnlock) {
		...
		try {
			...
			SVGString = SVGString.replaceAll("#ff2a2a",
					colourShade.getShades()[0]);
			SVGString = SVGString.replaceAll("#ff5555",
					colourShade.getShades()[1]);
			SVGString = SVGString.replaceAll("#ff8080",
					colourShade.getShades()[2]);
			SVGString = SVGString.replaceAll("#ffaaaa",
					colourShade.getShades()[3]);
			SVGString = SVGString.replaceAll("#ffd5d5",
					colourShade.getShades()[4]);
