...
import com.base.game.sex.sexActions.universal.dom.DomKneeling;
 ...
 * @author Innoxia
 */
public class SMBraxSubStart extends SexManagerDefault {
	
	
	public SMBraxSubStart() {
		super(// Self actions:
