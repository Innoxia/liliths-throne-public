...
public enum SexPosition {
	...
	BACK_TO_WALL_PARTNER_IN_CHARGE("Back to wall", "You're standing with your back to the wall, and in front of you, [npc.name] is eyeing you up with a hungry glint in [npc.her] [npc.eyes+]."),
	BACK_TO_WALL_PLAYER_IN_CHARGE("Partner's back to wall", "You're standing face-to-face with [npc.name] as you push [npc.herHim] back against the wall."),

	FACING_WALL_PARTNER_BEHIND("Face-to-wall (partner behind)", "You're standing with your face to the wall, and behind you, [npc.name] is pressing into your back as [npc.she] breathes down your neck."),
	FACING_WALL_PLAYER_BEHIND("Face-to-wall (behind partner)", "You're standing behind [npc.name] as you push [npc.herHim] into the wall."),
