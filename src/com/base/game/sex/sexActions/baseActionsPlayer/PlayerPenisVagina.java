...
public class PlayerPenisVagina {
	...
	/*
	 * Player tease (through clothing variant)
	 * Partner tease
	 * 
	 * Player Penetrate
	 ...
	 * 
	 * Partner react:
	 * 		Buck hips (with 5 descriptions)
	 * 		Resist
	 * 
	 * Player stop penetrate (only if dom or consensual)
	 * Partner stop penetrate
	 * 
	 */
	
	public static SexAction PLAYER_TEASE_COCK_OVER_PUSSY = new SexAction(
	...
	public static SexAction PARTNER_FORCE_COCK_OVER_PUSSY = new SexAction(
