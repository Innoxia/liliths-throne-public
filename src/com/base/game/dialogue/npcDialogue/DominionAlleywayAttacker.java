					...
					if(!Main.game.getCurrentRandomAttacker().isReactedToPregnancy()) {
						return "<p>"
								...
								+ "<p>"
									...
									+ " <b style='color:"+Femininity.valueOf(Main.game.getCurrentRandomAttacker().getFemininity()).getColour()()+";'>"
								...
								+ (Main.game.getCurrentRandomAttacker().hasFetish(Fetish.FETISH_PREGNANCY)  || Main.game.getCurrentRandomAttacker().hasFetish(Fetish.FETISH_BROODMOTHER)
										...
										+ "<p style='text-align:center;'>" 
											+ "<b style='color:" + Colour.GENERIC_SEX() + ";'>You ended up getting [npc.name] pregnant, and, although [npc.she] seems pleased, [npc.she] still wants to fight you!</b>"
										+ "</p>"
										...
										+"</p>"
										+ "<p style='text-align:center;'>" 
											+ "<b style='color:" + Colour.GENERIC_SEX() + ";'>You ended up getting [npc.name] pregnant, and now [npc.she] wants revenge!</b>"
										+ "</p>");
