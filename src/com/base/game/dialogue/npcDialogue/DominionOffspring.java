					...
					if(!Main.game.getCurrentRandomAttacker().isReactedToPregnancy()) {
						return "<p>"
								...
								+ "<p>"
									...
									+ " [npc.She]'s a <b style='color:"+Femininity.valueOf(Main.game.getCurrentRandomAttacker().getFemininity()).getColour().()+";'>"
									...
									+ " <b style='color:"+Main.game.getCurrentRandomAttacker().getRace().getColour().()+";'>[npc.race]</b>."
								+ "</p>"
								+ "<p>"
